	...
	<div class="row" style="margin-left:10%;">
		...
		<div class="col-md-6">
			...
			<form method="post" action="${cpath }/common/personLogin">
				...
				<button class="btn btn-primary btn-xl" id="indi_login" type="submit" style="height: 80px;">로그인</button>
			</form>
		</div>
		<div class="col-md-6">
			<h3>기업회원 로그인</h3>
			<form method="post" action="${cpath }/common/companyLogin">
				...
				<button class="btn btn-primary btn-xl" id="comp_login" type="submit" style="height: 80px;">로그인</button>
			</form>
		</div>
