                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <c:choose>
	                        ...
	                        <c:when test="${login.person_check == 'y' }">
	                        	<li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="${cpath }/reserve/reserve_new_for_engi">예약하기</a></li>
				        	...
				        	<c:otherwise>
				        		<%-- 고객 로그인시 --%>
				        		<li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="${cpath }/reserve/reserve_new_for_cust">예약하기</a></li>
