                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <img class="img-fluid rounded mb-5" src="${cpath }/resources/img/jaesun.jpeg" alt="..." />
									소속 : KG그룹 회장
                                    <p class="mb-4"></p>
                    ...
                    <div class="modal-body text-center pb-5">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                                                                  추천 엔지니어
                                    <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Eric Emerson Schmidt</h2>
                                    	주요분야 : 구글 엔지니어 수리
                                    <div class="divider-custom">
                                        <div class="divider-custom-line"></div>
                                        <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                    ...
                                    <img class="img-fluid rounded mb-5" src="${cpath }/resources/img/eric.jpg" alt="..." />
                                    	소속 : 전 구글 CEO
                                    <p class="mb-4"></p>
                                    <button class="btn btn-primary" href="#!" data-bs-dismiss="modal">
                                        <i class="fas fa-times fa-fw"></i>
                    ...
                    <div class="modal-body text-center pb-5">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                     	추천 엔지니어
                                    <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Lawrence Edward "Larry" Page</h2>
                                    	주요분야 : TV,에어컨 등 가전제품 일체
                                    <div class="divider-custom">
                                        <div class="divider-custom-line"></div>
                                        <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                        <div class="divider-custom-line"></div>
                                    </div>
                                    <img class="img-fluid rounded mb-5" src="${cpath }/resources/img/larry.jpg" alt="..." />
                                    	소속 : 구글 창업주
                                    <p class="mb-4"></p>
                                    <button class="btn btn-primary" href="#!" data-bs-dismiss="modal">
                                        <i class="fas fa-times fa-fw"></i>
