...
public class OrderDTO {
	...
	private String service_id, service_title, service_content, service_status, 
			service_address, service_reg, service_engineer, asComment, service_name, service_phone;;
